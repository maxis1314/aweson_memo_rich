...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
    ...
    >
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
           ...
           <el-link :underline="false" @click="download_id(scope.row.id)"></el-link>
               ...
               <el-table-column label="Key2"   width="" className="my-cell" sortable prop="key2">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.key2)"></span>
         <!--
            <no-ssr>
               <mavon-editor
      ...
      <el-table-column label="Created"   width="175" className="my-cell"><template slot-scope="scope"><span v-html="showHighlight(scope.row.created_at)"></span> </template> </el-table-column>
      ...
      <el-table-column align="left" label="List" className="my-cell">
        <template slot-scope="scope">        
         ...
         <el-button type="success" plain size="medium" icon="el-icon-s-custom" @click="handleCustom(scope.$index,scope.row)">OPTION</el-button>
            ...
            <div><!-- <el-tag type="success" size="mini">Key2</el-tag><br>-->
            <span v-html="showHighlight(scope.row.key2)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.key2"
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
         ...
         <el-button type="success" plain size="medium" icon="el-icon-s-custom" @click="handleCustom(index,item)">OPTION</el-button>
            ...
            <div><el-tag type="success" size="mini">Key2</el-tag><br>
            <span v-html="showHighlight(item.key2)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.key2"
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        <el-form :model="form"  label-width="100px">
            ...
            <el-form-item label="Key2">
               <el-input v-model="form.key2" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.key2" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
