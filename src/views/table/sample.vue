      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
           ...
           <el-link :underline="false" @click="download_id(scope.row.id)"></el-link>
               ...
               <el-table-column label="Tag"   width="" className="my-cell" sortable prop="tag"></el-table-column>
               <el-table-column label="IsDir"  width="" className="my-cell" sortable prop="is_dir">
                <template slot-scope="scope">
                  <div v-if="scope.row.is_dir"><span>DIR</span></div>
                 </template>
               </el-table-column>
               <el-table-column label="Size"   width="" className="my-cell" sortable prop="size"></el-table-column>
               <el-table-column label="Updated"   width="" className="my-cell" sortable prop="updated_at"></el-table-column>
    ...
    >
      ...
      <el-table-column align="left" label="List" className="my-cell">
        <template slot-scope="scope">        
            ...
            <span @click="show_drawer(scope.row)" v-html="showHighlight(scope.row.tag)"></span>
        <!--
         <no-ssr>
               <mavon-editor
...
import {rowDrop,goPath, handleCustom, download_id, download, show_dialog, do_submit, update_item, create_item, handleSizeChange, handleCurrentChange, fetchData, refresh, show_alert } from '@/utils/common_list'
        ...
        request({
             ...
             if(url.code == 20000){
               ...
               if(copy==0){
                ...
                this.show_alert(url.message,'warning')
             }
        })
      } else {
        this.id = ''
...
    },
    ...
    handleUploadSuccess(res, file, fileList){
        console.log(res)
         if(res.code && res.code == 20000){
            this.show_alert(res.message,'success')
         }
         this.fetchData()
    },
    ...
    $imgAdd(pos, $file){
           ...
           request({
               ...
               */
               this.$refs.md.$img2Url(pos, "/static2/mypic/"+url);
          })
     },
     drawLine(){
        request({
